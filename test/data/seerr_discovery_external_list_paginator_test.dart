...
ImdbExternalListItem _item(int id, {String type = 'Movie', String? tmdbId}) =>
...
void main() {
  test(
    'windows a large list instead of returning every card at once',
    () async {
  ...
  test(
    'normal reset reuses cached list while force refresh reloads it',
    () async {
      var loads = 0;
      final paginator = SeerrDiscoveryExternalListPaginator(
        pageSize: 2,
