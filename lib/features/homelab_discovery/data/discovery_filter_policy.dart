/// Allow-list and normalisation for server-delivered Discovery filters.
///
/// These are forwarded only through Moonbase's authenticated Seerr proxy. Any
/// unknown key is dropped instead of becoming an arbitrary query parameter.
abstract final class HomeLabDiscoveryFilterPolicy {
