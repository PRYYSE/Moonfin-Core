...
This revision targets the already-expanded external-list/browse source exactly.
"""
...
def main() -> int:
    ...
    if args.check:
        print("personalised_expanded_browse_patch_v2=present")
    else:
        print("personalised_expanded_browse_patch_v2=applied")
        for path in changed:
